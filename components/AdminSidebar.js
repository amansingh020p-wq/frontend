...
const AdminSidebar = ({ mobileSidebarOpen, onCloseMobileSidebar }) => {
  ...
  const menuItems = [
    ...
    { title: 'New User Requests', icon: UserPlus, path: '/admin/new-user-request' },
    { title: 'Deposit Requests', icon: CreditCard, path: '/admin/deposit-request' },
    { title: 'Withdraw Requests', icon: Wallet, path: '/admin/withdrawal-request' },
    // { title: 'Trade Orders', icon: TrendingUp, path: '/admin/trades-order-request' },
    // { title: 'Trade Sales', icon: TrendingUp, path: '/admin/trades-sell-request' },
    { title: 'Trade History', icon: TrendingUp, path: '/admin/trades-order-history' },
    // { title: 'Loan Requests', icon: DollarSign, path: '/admin/loan-request' },
    { title: 'Add Bank Account', icon: DollarSign, path: '/admin/add-account' },
    { title: 'All Users', icon: Users, path: '/admin/all-users' },
    // { title: 'User Profile', icon: Users, path: '/admin/user-profile' },
    { title: 'Account Settings', icon: Settings, path: '/admin/account-setting' },
  ];
